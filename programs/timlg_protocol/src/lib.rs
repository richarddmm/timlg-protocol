...
security_txt! {
    ...
    policy: "https://github.com/richarddmm/timlg-protocol/security/policy",

    // Optional fields
    preferred_languages: "en,es",
    source_code: "https://github.com/richarddmm/timlg-protocol",
    auditors: "None",
    acknowledgements: "https://github.com/richarddmm/timlg-protocol/security/acknowledgements"
}
